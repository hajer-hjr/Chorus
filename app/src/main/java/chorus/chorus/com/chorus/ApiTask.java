...
public abstract class ApiTask<Params, Progress, Result> extends AsyncTask<Params, Progress, Result> {
    ...
    ApiTask(Context _context, int _loadingMessage) {
        context = _context;
    ...
    protected void onPreExecute() {
        this.dialog.setMessage(context.getResources().getString(loadingMessage));
        this.dialog.show();
    }
    ...
    protected void showError() {
       if (error.equals("NO_CONNECTION_ERROR")) error = context.getResources().getString(R.string.error_no_connection);
        ...
        else if (error.equals("INVALID_USERNAME_OR_PASSWORD")) error = context.getResources().getString(R.string.error_invalid_username_or_password);
        ...
        else if (error.equals("EMPTY_VALUE_CONFIRM_PASSWORD")) error = context.getResources().getString(R.string.field_error_invalid_confirm_password);
        else if (error.equals("NOT_VALID_CONFIRM_PASSWORD")) error = context.getResources().getString(R.string.field_error_invalid_confirm_password);
